...
while player.hp > 0 or (angelus.alive_check()==True and bisontus.alive_check()==True 
                      and ear_plucker.alive_check()==True and the_driller.alive_check()==True):
    
    if loc==1 and player.hp > 0:
        print("This room it`s empty")
    ...
    elif loc==2 and angelus.alive_check()==True and player.hp > 0:
    ...
    elif loc==2 and angelus.alive_check()==False and player.hp > 0:
    ...
    elif loc==5 and bisontus.alive_check()==True and player.hp > 0:
        print("There is an oponent in this place!!")
    ...
    elif loc==5 and bisontus.alive_check()==False and player.hp > 0:
    ...
    elif loc==6 and the_driller.alive_check()==True and player.hp > 0:
        print("There is an oponent in this place!!")
    ...
    elif loc==6 and the_driller.alive_check()==False and player.hp > 0:
    ...
    elif loc==7 and ear_plucker.alive_check()==True and player.hp > 0:
        print("There is an oponent in this place!!")
    ...
    elif loc==7 and ear_plucker.alive_check()==False and player.hp > 0:
...
if player.hp <=0:
    ...
    print(f"Congratulations {player.name} you beat all the oponents. You won")
